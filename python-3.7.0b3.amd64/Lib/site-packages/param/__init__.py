...
try:
    ...
    _version = "1.5.2"  # Version(fpath=__file__, archive_commit="3ca7019", reponame="param")
    __version__ = "1.5.2"  # str(_version)
except:
    import json
    __version__ = "1.5.2"  # json.load(open(os.path.join(os.path.split(__file__)[0],
